...
function ObjectTrees(buffersCollection, texturesCollection){
    ...
    let Robot2 = new GenericObject(buffersCollection.trackBuffer, [reside, upCannons, loCannons], texturesCollection.Track);
    let Robot3 = new GenericObject(buffersCollection.trackBuffer, [reside, upCannons, loCannons], texturesCollection.Track);

    mat4.translate(Robot2.ModelMatrix, Robot2.ModelMatrix, vec3.fromValues(2,0,2));
    mat4.translate(Robot3.ModelMatrix, Robot3.ModelMatrix, vec3.fromValues(4,0,0));
