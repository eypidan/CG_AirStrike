...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ObjectTrees.js":[function(require,module,exports) {
 ...
 */
var GenericObject = function GenericObject(Buffers, LightPos, AdjObj, Luminous, Texture) {
...
function ObjectTrees(buffersCollection, texturesCollection) {
  // 在这里可以建设多个太阳系
  // 每个太阳系有独特的建系方程
  var ObjectsSystems = CreateObjectsSystem(buffersCollection, texturesCollection); // 太阳系1（机器人1）

  return ObjectsSystems;
}

function CreateObjectsSystem(buffersCollection, texturesCollection) {
  var ExampleModel = CreateObject(buffersCollection.ExampleModel, texturesCollection.Earth, [], false);
  return ExampleModel;
}

function CreateObject(buffers, Texture, AdjObj, Luminous) {
  var LightPos = [0, 0, 0];
  var Object = new GenericObject(buffers, LightPos, AdjObj, Luminous, Texture);
  return Object;
}
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ObjectTrees.js"], null)
//# sourceMappingURL=/ObjectTrees.5c3b1b59.map