...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Motion.js":[function(require,module,exports) {
...
function MoveForward(Object, deltaTime) {
  ...
  lookAtX += dx;
  lookAtZ += dz;
  Object.ModelMatrix = mat4.translate(Object.ModelMatrix, Object.ModelMatrix, vec3.fromValues(0, 0, Object.MotionParameters.Speed * deltaTime));
}

function RootRotate(root, deltaTime) {
  // 同时按下或者都不按下
  if (!dDown && !aDown || dDown && aDown) return;
  ...
  root.ModelMatrix = mat4.rotate(root.ModelMatrix, root.ModelMatrix, dTheta * Math.PI / 180, vec3.fromValues(0, 1, 0));
}
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Motion.js"], null)
//# sourceMappingURL=/Motion.9640926e.map