...
import {doMotion, Target} from "./Operations";
...
function main() {
    ...
    function render(now) {
        ...
        if (Target == 1)
            ...
            doMotion(Objects.Robot2, deltaTime);
        else if (Target == 3)
            doMotion(Objects.Robot3, deltaTime);
...
function updateLight(gl, programInfo)
{
    ...
    console.log(document.getElementById("directionalLightB").value)
    gl.uniform3f(
